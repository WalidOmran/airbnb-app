...
export const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || "https://airbnb-json-db.vercel.app";
export const apiUrl = process.env.NEXT_PUBLIC_API_URL || "https://airbnb-json-db.vercel.app";
